...
class G5SE7D(AddressList):
    ...
    p_RANDOMIZE_SHOP = 0x803d9003
    p_USE_KEY_RINGS = 0x803d9004
    p_SKIP_CUTSCENE_BUTTON = 0x803d9005
    p_ALLOW_TELEPORT_TO_HUB = 0x803d9006
    p_DISABLE_POPUPS = 0x803d9007
    p_INSTANT_ELEVATORS = 0x803d9008
    p_STARTING_REALM = 0x803d9009
    p_REALM_ACCESS = 0x803d900a
    p_PATCH_BEEN_WRITTEN_TO = 0x803d900e
    p_MW_SEED = 0x803d9010
    p_INIT = 0x803d9014
    p_BOSS_COSTS = 0x803d9018
    p_LG_DOOR_COSTS = 0x803d901c
    p_BALL_GADGET_COST = 0x803d9020
    p_INVINCIBILITY_COST = 0x803d9021
    p_SUPERCHARGE_COST = 0x803d9022
    p_BOSS_EASY_MODE = 0x803d9023
    p_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x803d9028
    p_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x803d902c
    p_XLS_SHOP_ROWCOUNT = 0x803d9030
    p_XLS_SHOP_ITEMS = 0x803d9034
    p_SHOP_TEXT = 0x803d9a34
    ...
    g_RANDOMIZE_SHOP = 0x80467d3f
    g_USE_KEY_RINGS = 0x80467d40
    g_SKIP_CUTSCENE_BUTTON = 0x80467d41
    g_ALLOW_TELEPORT_TO_HUB = 0x80467d42
    g_DISABLE_POPUPS = 0x80467d43
    g_INSTANT_ELEVATORS = 0x80467d44
    g_STARTING_REALM = 0x80467d45
    g_REALM_ACCESS = 0x80467d46
    g_PATCH_BEEN_WRITTEN_TO = 0x80467d4a
    g_MW_SEED = 0x80467d4c
    g_INIT = 0x80467d50
    g_BOSS_COSTS = 0x80467d54
    g_LG_DOOR_COSTS = 0x80467d58
    g_BALL_GADGET_COST = 0x80467d5c
    g_INVINCIBILITY_COST = 0x80467d5d
    g_SUPERCHARGE_COST = 0x80467d5e
    g_BOSS_EASY_MODE = 0x80467d5f
    g_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x80467d64
    g_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x80467d68
    g_XLS_SHOP_ROWCOUNT = 0x80467d6c
    g_XLS_SHOP_ITEMS = 0x80467d70
    g_SHOP_TEXT = 0x80468770
